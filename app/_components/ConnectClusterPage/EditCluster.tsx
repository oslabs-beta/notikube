        ...
        <form onSubmit={editCluster}>
          <div className="grid grid-cols-2 gap-8 w-4/5 resize">
            <div className="w-screen">
              ...
              <br></br>
              <button className="text-white bg-primary-500 hover:bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 w-36 mt-6 shadow-lg" type="submit">Save</button>
            </div>
          </div>
        </form>
      </div>
