...
export default function ConnectClusterSideBar() {
  ...
  const isConnectClusterPage = pathname === "/dashboard/connect-cluster"
    ...
    <>
      ...
      >
        <svg
          ...
          viewBox="0 0 20 20"
          fill="none"
          className={`${isConnectClusterPage ? "text-NotikubeRed" : ""}`}
        >
          <g opacity={isConnectClusterPage ? "1" : "0.4"}>
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              ...
              fill={isConnectClusterPage ? "#F04438" : "#000000"}
            />
          </g>
        </svg>
