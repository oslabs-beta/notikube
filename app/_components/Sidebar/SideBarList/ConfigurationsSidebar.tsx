...
export default function ConfigurationsSidebar() {
  const pathname = usePathname();
  const isConfigurationsPage = pathname === "/dashboard/configurations";
  ...
  return (
    <>
      ...
      >
        <svg
          aria-hidden="true"
          className={`${isConfigurationsPage ? "text-NotikubeRed" : ""}`}
          fill="currentColor"
          viewBox="0 0 24 24"
          width="24"
          height="24"
        ...
        >
          <g opacity={isConfigurationsPage ? "1" : "0.4"}>
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              ...
              fill={isConfigurationsPage ? "#F04438" : "#000000"}
            />
          </g>
        </svg>
