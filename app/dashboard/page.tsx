  ...
  // if (isLoaded) {
    return (
      <div>
        <Sidebar />
        <div className=''>
          <h1 className="text-left py-5 text-5xl font-extrabold dark:text-white">Dashboard</h1>
          ...
          <div id='metrics'>
            <section>
              <div id='dashboard-alerts'className='my-5 display: inline-flex'>
                <a href="/dashboard/alerts" className="block m-3 max-w-sm w-80 p-10 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <h3 className="text-left text-3xl font-bold dark:text-white py-3">Cluster</h3>
            <section id='cluster'>
           ...
           <h3 className="text-left text-3xl font-bold dark:text-white py-3">Nodes</h3>
