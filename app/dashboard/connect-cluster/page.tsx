...
import UserClusters from "../../_components/UserClusters";
...
export default function ConnectCluster() {
  ...
  async function newCluster(e: React.FormEvent) {
    ...
    const clusterNameElement = document.getElementById(
      "clusterName"
    ) as HTMLInputElement | null;
    const clusterIpElement = document.getElementById(
      "clusterIp"
    ) as HTMLInputElement | null;
    ...
    if (clusterNameElement && clusterIpElement) {
      ...
      // POST REQUEST TO ADD CLUSTER NAME AND CLUSTER IP TO DATABSE
      try {
  ...
  return (
    <div className="p4 flex flex-col justify-between">
          ...
          <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
              ...
              <form onSubmit={newCluster}>
                {/* Div to hold Cluster Name and IP Address Input Fields */}
