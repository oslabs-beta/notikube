      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          ...
          <div className="grid grid-cols-4 gap-6 text-gray-500 sm:gap-12 md:grid-cols-4 lg:grid-cols-4 dark:text-gray-400 justify-center">
            {/* Kubernetes Logo */}
            <a href="https://kubernetes.io/" className="flex justify-center items-center">
              <img
            ...
            {/* Docker Logo */}
            <a href="https://www.docker.com/" className="flex justify-center items-center">
              <img
            ...
            {/* Prometheus Logo */}
            <a href="https://prometheus.io/" className="flex justify-center items-center">
              <img
            ...
            {/* Grafana Logo */}
            <a href="https://grafana.com/" className="flex justify-center items-center">
              <img
